"""
Test Ensemble LIME Explainability
Quick test to verify ensemble LIME works with spine images
"""
...
from lime_explainer import generate_lime_ensemble, EnsembleLIMEExplainer


def test_ensemble_lime():
    """Test ensemble LIME implementation with spine image"""
    
    print("="*70)
    print("Ensemble LIME Explainability Test")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("Generating Ensemble LIME Visualization")
    print("="*70)
    ...
    try:
        ...
        output_path = 'test_ensemble_lime.png'
        fig.savefig(output_path, dpi=150, bbox_inches='tight', facecolor='white')
        plt.close(fig)
        print(f"\n✅ Ensemble LIME visualization saved: {output_path}")
        
    except Exception as e:
        print(f"\n❌ Error generating ensemble LIME: {e}")
        import traceback
        traceback.print_exc()
        return False
    ...
    print("="*70)
    print("\nGenerated file:")
    print("  • test_ensemble_lime.png")
    print("\nEnsemble LIME ready to use in web application!")
    
    return True


if __name__ == '__main__':
    success = test_ensemble_lime()
